...
async function findElement(selector) {
    ...
    if (!this.isDevTools && typeof selector === 'string' && selector.startsWith(constants_1.DEEP_SELECTOR)) {
        ...
        let elem = await this.execute(webdriverio_1.locatorStrategy, selector.slice(constants_1.DEEP_SELECTOR.length));
...
async function findElements(selector) {
     ...
     */
    if (!this.isDevTools && typeof selector === 'string' && selector.startsWith(constants_1.DEEP_SELECTOR)) {
        const elems = await this.execute(webdriverio_1.locatorStrategy, selector.slice(constants_1.DEEP_SELECTOR.length));
